...
/*
 ...
 - 2015/05/27 (1.40) - removed the third 'repeat_if_held' parameter from ButtonReset() - sorry! it was rarely used and inconsistent. Use PushButtonRepeat(true) / PopButtonRepeat() to enable repeat on desired buttons.
 ...
 A: A primer on labels and the ID Stack...
    ...
    Interactive widgets (such as calls to ButtonReset buttons) need a unique ID.
    Unique ID are used internally to track active widgets and occasionally associate state to widgets.
    Unique ID are implicitly built from the hash of multiple elements that identify the "path" to the UI element.

   - Unique ID are often derived from a string label:

       ButtonReset("OK");          // Label = "OK",     ID = hash of (..., "OK")
       ButtonReset("Cancel");      // Label = "Cancel", ID = hash of (..., "Cancel")
   ...
   - ID are uniquely scoped within windows, tree nodes, etc. which all pushes to the ID stack. Having
     ...
     We used "..." above to signify whatever was already pushed to the ID stack previously:
       ...
       Begin("MyWindow");
       ButtonReset("OK");          // Label = "OK",     ID = hash of ("MyWindow", "OK")
       End();
       Begin("MyOtherWindow");
       ButtonReset("OK");          // Label = "OK",     ID = hash of ("MyOtherWindow", "OK")
       End();

   - If you have a same ID twice in the same location, you'll have a conflict:

       ButtonReset("OK");
       ButtonReset("OK");          // ID collision! Interacting with either button will trigger the first one.
   ...
   - Solving ID conflict in a simple/local context:
     ...
     are going to be created:
       ...
       Begin("MyWindow");
       ButtonReset("Play");        // Label = "Play",   ID = hash of ("MyWindow", "Play")
       ButtonReset("Play##foo1");  // Label = "Play",   ID = hash of ("MyWindow", "Play##foo1")  // Different from above
       ButtonReset("Play##foo2");  // Label = "Play",   ID = hash of ("MyWindow", "Play##foo2")  // Different from above
       End();
   ...
   - Occasionally/rarely you might want change a label while preserving a constant ID. This allows
     ...
     but windows are uniquely identified by their ID. Use "###" to pass a label that isn't part of ID:
       ...
       ButtonReset("Hello###ID");  // Label = "Hello",  ID = hash of (..., "###ID")
       ButtonReset("World###ID");  // Label = "World",  ID = hash of (..., "###ID")  // Same as above, even though the label looks different
   ...
   - Solving ID conflict in a more general manner:
     ...
     Begin("Window");
       for (int i = 0; i < 100; i++)
       {
         ...
         ButtonReset("Click");     // Label = "Click",  ID = hash of ("Window", i, "Click")
         PopID();
       }
       for (int i = 0; i < 100; i++)
       {
         ...
         PushID(obj);
         ButtonReset("Click");     // Label = "Click",  ID = hash of ("Window", obj pointer, "Click")
         PopID();
       }
       for (int i = 0; i < 100; i++)
       {
         MyObject* obj = Objects[i];
         PushID(obj->Name);
         ButtonReset("Click");     // Label = "Click",  ID = hash of ("Window", obj->Name, "Click")
         PopID();
       }
       End();
   ...
   - You can stack multiple prefixes into the ID stack:
       ...
       ButtonReset("Click");       // Label = "Click",  ID = hash of (..., "Click")
       PushID("node");
       ButtonReset("Click");       // Label = "Click",  ID = hash of (..., "node", "Click")
         PushID(my_ptr);
           ButtonReset("Click");   // Label = "Click",  ID = hash of (..., "node", my_ptr, "Click")
         PopID();
       PopID();
...
const char* ImGui::GetStyleColorName(ImGuiCol idx)
{
    ...
    case ImGuiCol_Button: return "ButtonReset";
