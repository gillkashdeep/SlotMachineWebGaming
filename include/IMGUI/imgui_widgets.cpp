...
// [SECTION] Widgets: Main (ButtonReset, Image, Checkbox, RadioButton, ProgressBar, Bullet, etc.)
...
bool ImGui::InvisibleButton(const char* str_id, const ImVec2& size_arg)
{
    ...
    // Cannot use zero-size for InvisibleButton(). Unlike ButtonReset() there is not way to fallback using the label size.
...
// Render text label (with custom clipping) + Unsaved Document marker + Close ButtonReset logic
